...
function reloadCapacity() {
    fetch("/_capacity")
        ...
        .then(function (data) {
            console.log(data);
            if (capacity) capacity.innerHTML = `Capacity: ${data["capacity"]}`;
        })
        .catch(function (err) {
            // There was an error
...
captureButton?.addEventListener("click", function () {
    ...
    fetch("/_check_face")
        ...
        .then(function (data) {
            ...
            modalHeader.classList.remove("text-red-500");
        ...
        .catch(function (err) {
            ...
            modalHeader.classList.add("text-red-500");
            modalText.innerHTML =
                "A client side error has occurred. Please check logs and try again later.";
